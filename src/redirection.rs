...
pub async fn close_stdout_duped_fd(
    ...
    let stdout_duped_fd = current_execution
...
pub async fn redirect_io_stream(
        ...
        .is_none()
    {
        ...
        let cstr_address =
            (regs.rsp::<usize>() - RED_ZONE_SIZE - file_name.len() - 1) as *const c_char;
        ...
        current_execution.add_stdout_duped_fd(new_fd as i32, tracer.curr_proc);
